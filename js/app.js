...
const BOOKING_ENDPOINT = "https://YOUR-N8N-DOMAIN.com/webhook/eh-bin-booking";
...
function normalizeBookingPayload(formData) {
  ...
  return {
    ...
    City: formData.city || "",
    Plan: formData.plan || "Not Sure Yet",
    "Number of Bins": numberOfBins,
    "Preferred Day": formData.day || "Any Day",
