...
const translations = {
  en: {
    ...
    common: { call: "Call", viewPlans: "View plans" },
    footer: {
  ...
  es: {
    ...
    common: { call: "Llamar", viewPlans: "Ver planes" },
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  if (!localStorage.getItem("eh_lang")) modal.hidden = false;

  document.querySelectorAll("[data-set-lang], [data-choose-lang]").forEach((btn) => {
    btn.addEventListener("click", () => {
      lang = btn.dataset.setLang || btn.dataset.chooseLang;
